...
| ประเภท | category / type / class | กลุ่มของสินค้า 1 ใน 6 กลุ่ม (วัตถุดิบ/สารสกัด/แพคเกจจิ้ง/วัสดุสิ้นเปลือง/อะไหล่/สินค้าสำเร็จรูป) |
| สินค้าสำเร็จรูป | finished good / FG / product | สินค้าหลังบรรจุพร้อมขาย (เช่น "เซรั่มโสมแดง 30g") — เลือกได้ตอนตั้งแผนผลิต |
...
| ประเภท | enum | สารสกัด | 1 ใน 6: วัตถุดิบ / สารสกัด / แพคเกจจิ้ง / วัสดุสิ้นเปลือง / อะไหล่ / สินค้าสำเร็จรูป |
...
| batch | string | B-2605-001 | auto-generate `B-YYMM-NNN` reset ต่อเดือน |
| item_id | string | ITM-020 | FK → Master_Items (ประเภท=สินค้าสำเร็จรูป) |
| สินค้า | string | เซรั่มโสมแดง 30g | snapshot ชื่อตอนสร้าง (กันชื่อเปลี่ยน) |
| เป้า | number | 1000 | จำนวนเป้าผลิต |
| หน่วยผลผลิต | string | ขวด | snapshot จาก Master_Items.หน่วย |
...
**Production rules:**
- ตั้งเป้า → เลือก item_id ของสินค้าสำเร็จรูป (ประเภท=สินค้าสำเร็จรูป เท่านั้น) → batch + plan_id รันอัตโนมัติ
